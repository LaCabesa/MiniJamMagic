...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        player_walk_3 = pygame.image.load(
            'graphics/player/player_walk_3.png').convert_alpha()
        player_walk_4 = pygame.image.load(
            'graphics/player/player_walk_4.png').convert_alpha()
        self.player_walk = [player_walk_1,
                            player_walk_2, player_walk_3, player_walk_4]
        self.player_index = 0
        self.player_jump = pygame.image.load(
            'graphics/player/jump.png').convert_alpha()

        self.image = self.player_walk[self.player_index]
        self.rect = self.image.get_rect(midbottom=(80, 290))
        self.gravity = 0
...
def display_score():
    ...
    score_surf = test_font.render(
        f'Score: {current_time * current_time}', False, (64, 64, 64))
...
score_surf = test_font.render('Thrash Wizard', False, (64, 64, 64))
score_rect = score_surf.get_rect(center=(400, 50))
...
player_stand_rect = player_stand.get_rect(center=(250, 200))

bottle_surf = pygame.image.load('graphics/bottle2.png').convert_alpha()
bottle_rect = bottle_surf.get_rect(center=(500, 400))


game_name = test_font.render('Trash Runner', False, (111, 196, 169))
